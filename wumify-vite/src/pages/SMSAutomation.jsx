      ...
      <section className="relative w-full max-w-5xl mx-auto px-8 pt-20 pb-16 z-10 text-center">
        ...
        >
          ...
          <p className="text-hero-sub text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-12 opacity-80">
            Automate text message follow-ups, trigger instant answers to cold leads, and book customers via automated SMS workflows.
          </p>
        </motion.div>
      </section>
      ...
      <section className="w-full max-w-7xl mx-auto px-8 pb-32 z-10 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="liquid-glass border border-white/10 rounded-2xl p-8">
          <div className="text-wumify-purple mb-4">
            <iconify-icon icon="solar:letter-linear" width="36" height="36" />
          </div>
          <h3 className="text-xl font-general font-medium text-white mb-2">Speed to Lead</h3>
          <p className="text-sm text-foreground/60 leading-relaxed">
            Answer lead queries within 30 seconds of form submission, increasing booking conversion rates by up to 300%.
          </p>
        </div>
        ...
        <div className="liquid-glass border border-white/10 rounded-2xl p-8">
          ...
          <h3 className="text-xl font-general font-medium text-white mb-2">Automated Booking</h3>
          <p className="text-sm text-foreground/60 leading-relaxed">
            AI text engines converse with customers, verify convenient times, and book meetings directly into the CRM.
          </p>
        </div>

        <div className="liquid-glass border border-white/10 rounded-2xl p-8">
          <div className="text-wumify-purple mb-4">
            <iconify-icon icon="solar:checklist-linear" width="36" height="36" />
          </div>
          <h3 className="text-xl font-general font-medium text-white mb-2">Secure API Gateway</h3>
          <p className="text-sm text-foreground/60 leading-relaxed">
            Full compliance with local UK mobile carriers and text registry standards to ensure high message deliverability.
          </p>
        </div>
      </section>
