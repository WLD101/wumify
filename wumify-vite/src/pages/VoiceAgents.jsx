      ...
      <section className="relative w-full max-w-5xl mx-auto px-8 pt-20 pb-16 z-10 text-center">
        ...
        >
          ...
          <h1 className="font-general text-4xl md:text-7xl font-medium tracking-tight mb-6 text-white leading-tight">
            AI Voice <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-wumify-cyan to-wumify-purple">Agents</span>
          </h1>
          <p className="text-hero-sub text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-12 opacity-80">
            Deploy human-like voice agents that answer inbound phone lines, schedule bookings, route calls, and update your CRM instantly 24/7.
          </p>
        </motion.div>
      </section>
      ...
      <section className="w-full max-w-7xl mx-auto px-8 pb-32 z-10 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="liquid-glass border border-white/10 rounded-2xl p-8">
          <div className="text-wumify-purple mb-4">
            <iconify-icon icon="solar:phone-calling-linear" width="36" height="36" />
          </div>
          <h3 className="text-xl font-general font-medium text-white mb-2">Zero Latency Voice</h3>
          <p className="text-sm text-foreground/60 leading-relaxed">
            Ultra-fast speech-to-text and text-to-speech processing ensures conversations flow naturally without mechanical pauses.
          </p>
        </div>

        <div className="liquid-glass border border-white/10 rounded-2xl p-8">
          <div className="text-wumify-purple mb-4">
            <iconify-icon icon="solar:calendar-date-linear" width="36" height="36" />
          </div>
          <h3 className="text-xl font-general font-medium text-white mb-2">Direct Appointment Booking</h3>
          <p className="text-sm text-foreground/60 leading-relaxed">
            The AI checks calendar availability in real-time and books clients directly on Google Calendar during calls.
          </p>
        </div>
        ...
        <div className="liquid-glass border border-white/10 rounded-2xl p-8">
          ...
          <h3 className="text-xl font-general font-medium text-white mb-2">Instant CRM Update</h3>
          <p className="text-sm text-foreground/60 leading-relaxed">
            All details, phone numbers, addresses, and call transcripts are programmatically logged to Salesforce, HubSpot, or custom portals.
          </p>
        </div>
      </section>
